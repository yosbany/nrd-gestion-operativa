...
# Obtener el directorio raíz del proyecto (dos niveles arriba de tools/nrd-gestion-operativa-server)
...
start_server() {
    ...
    echo "   Accede a: http://localhost:$PORT"
    echo "   Para detener: ./tools/nrd-gestion-operativa-server/server.sh"
